...
class AIEngine:
    ...
    def stockout_losses(self):
        ...
        for r in rows:
            ...
            """, (self.store_id, r["id"] if "id" in r.keys() else 0)).fetchone()
    ...
    def weather_impact_summary(self):
        ...
        impacts = WEATHER_IMPACT.get(dominant, {})
        return {"dominant_condition": dominant, "impacts": impacts}
